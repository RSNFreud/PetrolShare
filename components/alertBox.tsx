...
import {Dimensions, Modal, Pressable, TouchableWithoutFeedback, View} from 'react-native';
...
export default () => {
    ...
    useEffect(() => {
        ...
        EventRegister.addEventListener('closeAlert', (e: AlertDataType) => {
            setVisible(false);
        });
        return () => {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {!!data?.title && (
                            <Text style={{fontWeight: 'bold', lineHeight: 24}}>{data.title}</Text>
                        )}
                        {!!data?.message && (
