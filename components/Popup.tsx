...
export default ({
  ...
  let maxHeight = useRef(
    new Animated.Value(Dimensions.get('window').height * 0.9 - keyboardPadding),
  ).current
  ...
  useEffect(() => {
    console.log(60, keyboardPadding)
  }, [keyboardPadding])
    ...
    >
      ...
      <Animated.View
        ...
        style={{
          ...
          bottom: 0,
          width: '100%',
          maxHeight: Dimensions.get('window').height * 0.9 - keyboardPadding,
          zIndex: 2,
          display: 'flex',
