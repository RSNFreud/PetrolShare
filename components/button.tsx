import { TouchableOpacity, TextProps, ActivityIndicator, View } from "react-native"
...
export const TouchableBase = ({ children, style, disabled, handleClick, analyticsLabel }: BaseType) => {
