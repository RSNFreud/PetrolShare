...
export default () => {
    ...
    return <Animated.View style={{ width: Dimensions.get('window').width, opacity: fadeAnim, height: Dimensions.get('window').height, position: 'absolute', top: 0, left: 0, zIndex: 1000, backgroundColor: Colors.background, justifyContent: 'center', alignContent: 'center', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
