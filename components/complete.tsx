...
export default ({groupID, newGroup, handleClose}: PropsType) => {
    ...
    const copyToClipboard = async () => {
        Clipboard.setStringAsync(
            `https://petrolshare.freud-online.co.uk/short/referral?groupID=${groupID}` || 'test',
        );
        setCopied(true);
        setTimeout(() => {
            setCopied(false);
    ...
    return (
        <View>
            ...
            <Text style={{fontSize: 16, lineHeight: 25}}>
                Share this with other members in your group to add them to your account. You can
                access this ID number at any time from your dashboard.
            </Text>
