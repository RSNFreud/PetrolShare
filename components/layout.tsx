    ...
    <>
      ...
      >
        ...
        {homepage || noScrollView ? <View
          style={{ paddingBottom: homepage 
        ||noBottomPadding? 0 : 55, paddingHorizontal: homepage ? 0 : 25, maxHeight: Dimensions.get('window').height - 95 - 77 }}>
          <>{children}</>
        </View> : <ScrollView nestedScrollEnabled={true} keyboardShouldPersistTaps={'handled'} contentContainerStyle={{paddingBottom:noBottomPadding ? 0
