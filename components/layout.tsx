      ...
      >
        ...
        {isLoggedIn &&
          <View style={{ backgroundColor: Colors.secondary, width: '100%', display: 'flex', justifyContent: 'space-between', flexDirection: 'row', paddingHorizontal: 25 }}>
            ...
            <BottomNavItem active={route.name === "History"} text='History' handleClick={() => navigate("History")} icon={<Svg width="20" height="20" fill="none">
              <Path
                fill="#fff"
            ...
            <BottomNavItem active={route.name === "Payments"} text='Payments' handleClick={() => navigate("Payments")} icon={<Svg
              width="15"
              height="20"
              fill="none"
              viewBox="0 0 15 20"
