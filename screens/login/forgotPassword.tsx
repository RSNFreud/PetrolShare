        ...
        >
            {isEmailSent ? (
                <View>
                    <>
                        ...
                        <Text style={{lineHeight: 21, fontSize: 16}}>
                            Your request has been received and if the email exists in our database
                            you will receive an email within the next few minutes with password
                            reset instructions.
                        </Text>
                    </>
                </View>
                ...
                <>
                    ...
                    />
                    <Button loading={loading} handleClick={sendEmail} text="Send Recovery Email" />
                </>
            )}
        </Popup>
    );
