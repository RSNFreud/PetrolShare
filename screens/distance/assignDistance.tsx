...
export default ({ handleClose }: { handleClose: (alert?: string) => void }) => {
  ...
  return (
    <>
      ...
      >
        <Text>
          If you have distance that should be applied to another user then enter
          the distance. This will prompt the user to accept the distance
          applied.
        </Text>
      </Box>
      <Dropdown
        ...
        data={usernames}
        handleSelected={(e) => setValues({ ...values, name: e })}
        value={values.name}
